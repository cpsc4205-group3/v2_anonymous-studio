...
### User Management
- **Metadata Strategy**: Use `user_metadata` for user-controlled preferences; `app_metadata` for application-controlled data (roles, flags). Never store sensitive secrets in metadata.
